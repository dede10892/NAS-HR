...
export class ReportsSalaryPage {
  ...
  flowSteps = [
    { num: '01', title: 'Attendance Data',   desc: 'Check-ins, shifts, and punches collected automatically from fingerprint, GPS, and mobile devices.',   icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z',                                                                                                                                     screenshot: '/attendence-reports/Fingerprint (3).png' },
    { num: '02', title: 'HR Processing',     desc: 'Leave requests, permissions, and employee records are merged and validated in real time by the system.', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2',                                                  screenshot: '/attendence-reports/Request Permission (close) (1).png' },
    { num: '03', title: 'Report Generation', desc: 'Instant summaries generated by period, department, or employee — ready to review in your dashboard.',   icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z', screenshot: '/attendence-reports/attendance report .jpeg' },
    { num: '04', title: 'Finance Export',    desc: 'One-click payroll-ready files exported to Excel or CSV — formatted exactly for your finance team.',      icon: 'M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4',                                                                                                                    screenshot: '/attendence-reports/Bonus History .jpeg' },
  ];
}
