...
export class AllFeaturesPage implements AfterViewInit {
  ...
  modules = [
    ...
    },
    {
      ...
      benefits: ['Shift scheduling', 'Missing punch handling', 'Location-based punching', 'Payroll-ready sync'],
    },
    {
  ...
  @ViewChildren('moduleCard') cards!: QueryList<ElementRef>;
